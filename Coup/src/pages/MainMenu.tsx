    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-950 via-gray-900 to-gray-950 flex flex-col items-center justify-center relative overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col gap-4 w-80">
                ...
                >
                    <span className="relative z-10">Nova Partida (Local)</span>
                ...
                <button
                    ...
                    className="group relative w-full py-4 px-8 rounded-xl font-bold text-lg transition-all duration-300 bg-gradient-to-r from-blue-500 to-blue-600 text-white hover:from-blue-400 hover:to-blue-500 hover:shadow-lg hover:shadow-blue-500/25 hover:-translate-y-0.5 active:translate-y-0"
                >
                    <span className="relative z-10">Multiplayer Online</span>
                    <div className="absolute inset-0 rounded-xl bg-gradient-to-r from-blue-300 to-blue-400 opacity-0 group-hover:opacity-100 transition-opacity duration-300 blur-sm -z-10" />
                </button>
            </div>
